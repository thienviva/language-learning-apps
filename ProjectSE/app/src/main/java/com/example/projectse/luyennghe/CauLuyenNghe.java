...
public class CauLuyenNghe implements Serializable {
    private int idbai;
    private int idbo;
    ...
    public CauLuyenNghe(int idbai, int idbo, String dapanA, String dapanB, String dapanC, String dapanD, String dapanTrue, byte[] hinhanh, String audio) {
        this.idbai = idbai;
        this.idbo = idbo;
        this.dapanA = dapanA;
        this.dapanB = dapanB;
